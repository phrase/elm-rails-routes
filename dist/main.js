...
var _user$project$Ports$read = _elm_lang$core$Native_Platform.incomingPort('read', _elm_lang$core$Json_Decode$string);
var _user$project$Ports$write = _elm_lang$core$Native_Platform.outgoingPort(
	'write',
	function (v) {
		return v;
	});

var _user$project$Scope$contains = F2(
	function (path, scope) {
		var _p0 = scope;
		if (_p0.ctor === 'Everything') {
			return true;
		} else {
			var _p7 = _p0._0;
			var _p1 = path;
			if (_p1.ctor === '[]') {
				...
				var _p6 = _p1._1;
				var _p2 = _p1._0;
				if (_p2.ctor === 'Anything') {
					return A2(
						_elm_lang$core$List$any,
						function (_p3) {
							return A2(
								_user$project$Scope$contains,
								_p6,
					...
					return A2(
						...
						function (_p4) {
							var _p5 = _p4;
							return _elm_lang$core$Native_Utils.eq(_p2._0, _p5._0) && A2(_user$project$Scope$contains, _p6, _p5._1);
						},
						_p7);
				}
			}
...
var _user$project$Scope$Everything = {ctor: 'Everything'};
var _user$project$Scope$decoder = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: A2(
			_elm_lang$core$Json_Decode$map,
			_user$project$Scope$Scope,
			_elm_lang$core$Json_Decode$keyValuePairs(
				_elm_lang$core$Json_Decode$lazy(
					function (_p8) {
						return _user$project$Scope$decoder;
					}))),
		_1: {
			ctor: '::',
			_0: A2(
				...
				function (name) {
					var _p9 = name;
					if (_p9 === '*') {
						return _elm_lang$core$Json_Decode$succeed(_user$project$Scope$Everything);
					} else {
						return _elm_lang$core$Json_Decode$fail('expecting \"*\"');
					}
				},
...
var _user$project$Scope$Anything = {ctor: 'Anything'};
var _user$project$Scope$Verbatim = function (a) {
	return {ctor: 'Verbatim', _0: a};
};

var _user$project$Route$nameParser = _elm_tools$parser$Parser$source(
	A2(
...
var _user$project$Route$spaces = A2(
	_elm_tools$parser$Parser$ignore,
...
var _user$project$Route$asElm = function (_p0) {
	var _p1 = _p0;
	var _p4 = _p1._0.uri;
	var name = _elm_community$string_extra$String_Extra$decapitalize(
		_elm_community$string_extra$String_Extra$camelize(_p1._0.prefix));
	var extractResources = function (uriParts) {
		return _elm_lang$core$List$concat(
			A2(
				_elm_lang$core$List$map,
				function (uriPart) {
	...
	var resources = extractResources(_p4);
	...
	var path = _elm_lang$core$String$concat(
		{
			ctor: '::',
			_0: '[ ',
			_1: {
					...
					_1: {
						...
						_0: A2(
							...
							A2(
								...
								1 + _elm_lang$core$List$length(resources),
								'String')),
						_1: {ctor: '[]'}
					}
				}),
...
var _user$project$Route$uriToPath = function (uri) {
	return A2(
		_elm_lang$core$List$filterMap,
		function (uriPart) {
			var _p5 = uriPart;
			switch (_p5.ctor) {
				case 'Verbatim':
					return _elm_lang$core$Maybe$Just(
						_user$project$Scope$Verbatim(_p5._0));
				case 'Resource':
					return _elm_lang$core$Maybe$Just(_user$project$Scope$Anything);
				default:
					return _elm_lang$core$Maybe$Nothing;
			}
		},
...
var _user$project$Route$filter = F2(
	function (_p7, _p6) {
		var _p8 = _p7;
		var _p9 = _p6;
		var _p10 = _p9._0;
		return (A2(
			_user$project$Scope$contains,
			_user$project$Route$uriToPath(_p10.uri),
			_p8.include) && (!A2(
			_user$project$Scope$contains,
			_user$project$Route$uriToPath(_p10.uri),
			_p8.exclude))) ? _elm_lang$core$Maybe$Just(_p9) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Route$RouteData = F4(
	function (a, b, c, d) {
		return {prefix: a, verb: b, uri: c, optional: d};
	});
var _user$project$Route$Route = function (a) {
	return {ctor: 'Route', _0: a};
};
var _user$project$Route$Delete = {ctor: 'Delete'};
var _user$project$Route$Put = {ctor: 'Put'};
var _user$project$Route$Patch = {ctor: 'Patch'};
var _user$project$Route$Post = {ctor: 'Post'};
var _user$project$Route$Get = {ctor: 'Get'};
var _user$project$Route$verbParser = function () {
	var matchKeyword = F2(
		function (string, constructor) {
			return A2(
				_elm_tools$parser$Parser$map,
				_elm_lang$core$Basics$always(constructor),
				_elm_tools$parser$Parser$keyword(string));
		});
	return _elm_tools$parser$Parser$oneOf(
		{
			ctor: '::',
			_0: A2(matchKeyword, 'GET', _user$project$Route$Get),
			_1: {
				ctor: '::',
				_0: A2(matchKeyword, 'POST', _user$project$Route$Post),
				_1: {
					ctor: '::',
					_0: A2(matchKeyword, 'PATCH', _user$project$Route$Patch),
					_1: {
						ctor: '::',
						_0: A2(matchKeyword, 'PUT', _user$project$Route$Put),
						_1: {
							ctor: '::',
							_0: A2(matchKeyword, 'DELETE', _user$project$Route$Delete),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Route$Dot = {ctor: 'Dot'};
var _user$project$Route$Resource = function (a) {
	return {ctor: 'Resource', _0: a};
};
var _user$project$Route$Verbatim = function (a) {
	return {ctor: 'Verbatim', _0: a};
};
var _user$project$Route$uriPartParser = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_elm_tools$parser$Parser$delayedCommit,
			_elm_tools$parser$Parser$symbol(':'),
			A2(_elm_tools$parser$Parser$map, _user$project$Route$Resource, _user$project$Route$nameParser)),
		_1: {
			ctor: '::',
			_0: A2(
				_elm_tools$parser$Parser$map,
				function (_p11) {
					return _user$project$Route$Dot;
				},
				_elm_tools$parser$Parser$symbol('.')),
			_1: {
				ctor: '::',
				_0: A2(_elm_tools$parser$Parser$map, _user$project$Route$Verbatim, _user$project$Route$nameParser),
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$Route$uriParserHelp = function (uriParts) {
	return A2(
		...
		_elm_tools$parser$Parser$oneOf(
			{
				...
				_0: A2(
					...
					A2(
						...
						function (uriPart) {
							return _user$project$Route$uriParserHelp(
								{ctor: '::', _0: uriPart, _1: uriParts});
						},
						_user$project$Route$uriPartParser)),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_tools$parser$Parser$andThen,
					...
					_1: {
						...
						_0: _elm_tools$parser$Parser$succeed(
							_elm_lang$core$List$reverse(uriParts)),
						_1: {ctor: '[]'}
					}
				}
			}));
};
var _user$project$Route$actualUriParser = A2(
	_elm_tools$parser$Parser_ops['|='],
	_elm_tools$parser$Parser$succeed(_elm_lang$core$Basics$identity),
	A2(
		_elm_tools$parser$Parser$andThen,
		...
		_user$project$Route$uriPartParser));
var _user$project$Route$uriParser = A2(
	_elm_tools$parser$Parser_ops['|='],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		_elm_tools$parser$Parser$succeed(_elm_lang$core$Basics$identity),
		_elm_tools$parser$Parser$symbol('/')),
	_user$project$Route$actualUriParser);
var _user$project$Route$routeParser = A2(
	_elm_tools$parser$Parser$map,
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_tools$parser$Parser_ops['|.'],
								_elm_tools$parser$Parser$succeed(_user$project$Route$RouteData),
								_user$project$Route$spaces),
							A3(
								_elm_tools$parser$Parser$delayedCommitMap,
								F2(
									function (name, _p12) {
								...
								_user$project$Route$nameParser,
								_elm_tools$parser$Parser$succeed(
									{ctor: '_Tuple0'}))),
						_user$project$Route$spaces),
					_user$project$Route$verbParser),
				_user$project$Route$spaces),
			_user$project$Route$uriParser),
		_elm_tools$parser$Parser$oneOf(
			{
				ctor: '::',
				_0: A2(
...
var _user$project$Route$parse = function (line) {
	return _elm_lang$core$Result$toMaybe(
		A2(_elm_tools$parser$Parser$run, _user$project$Route$routeParser, line));
};
				...
				_elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							...
							_1: _elm_lang$core$Json_Encode$list(
								A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, config.modulePrefix))
						},
						_1: {
							ctor: '::',
							_0: {
								...
								_1: _elm_lang$core$Json_Encode$string(
									A2(_elm_lang$core$Basics_ops['++'], config.moduleName, '.elm'))
							},
							_1: {
								ctor: '::',
								_0: {
											...
											'\n\n\n',
											{
												...
												_1: {
													...
													_0: A2(
														...
														A2(
															_elm_lang$core$List$map,
															_user$project$Route$asElm,
															A2(
																_elm_lang$core$List$filterMap,
																_user$project$Route$filter(
																	{include: config.include, exclude: config.exclude}),
																A2(
																	_elm_lang$core$List$filterMap,
																	_user$project$Route$parse,
																	A2(_elm_lang$core$String$split, '\n', routes))))),
													_1: {ctor: '[]'}
												}
											}))
...
var _user$project$Main$Config = F4(
	function (a, b, c, d) {
		return {moduleName: a, modulePrefix: b, include: c, exclude: d};
	});
var _user$project$Main$configDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'exclude',
	_user$project$Scope$decoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'include',
		_user$project$Scope$decoder,
		A3(
			...
			A2(
				_elm_lang$core$Json_Decode$map,
				function (rawModulePrefix) {
					var _p0 = rawModulePrefix;
					if (_p0 === '') {
						return {ctor: '[]'};
					} else {
						return A2(_elm_lang$core$String$split, '.', rawModulePrefix);
					}
				},
				_elm_lang$core$Json_Decode$string),
			A3(
				...
				'module-name',
				_elm_lang$core$Json_Decode$string,
				_elm_lang$core$Json_Decode$succeed(_user$project$Main$Config)))));
var _user$project$Main$init = function (value) {
	var _p1 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Main$configDecoder, value);
	if (_p1.ctor === 'Err') {
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
...
var _user$project$Main$main = _elm_lang$core$Platform$programWithFlags(
	{
		...
		subscriptions: function (_p3) {
			return _user$project$Ports$read(_elm_lang$core$Basics$identity);
		}
